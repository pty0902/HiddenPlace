function Bookmark(titleImgURL,mrTitleImgURL,bookmarkNum,userNickname, regionName, themeName, title, content, writeDate, storeName, latitude, longitude, detailAddress, nowLoginId) {
